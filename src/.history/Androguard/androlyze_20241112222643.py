...
def AnalyzeDex(filename, raw=False, decompiler=None):
    ...
    """
    print(f"in AnalyzeDex 0")
    # TO DO I AM HERE
    androconf.debug("DalvikVMFormat ...")
    print(f"in AnalyzeDex 1")
    d = None
    ...
    print(f"in AnalyzeDex 2")
    androconf.debug("Export VM to python namespace")
    d.create_python_export()
    print(f"in AnalyzeDex 3")
    androconf.debug("VMAnalysis ...")
    dx = uVMAnalysis(d)
    print(f"in AnalyzeDex 4")
    androconf.debug("GVMAnalysis ...")
    gx = GVMAnalysis(dx, None)
    print(f"in AnalyzeDex 5")
    d.set_vmanalysis(dx)
    print(f"in AnalyzeDex 6")
    d.set_gvmanalysis(gx)
    print(f"in AnalyzeDex 7")
    RunDecompiler(d, dx, decompiler)
    print(f"in AnalyzeDex 8")
    androconf.debug("XREF ...")
    d.create_xref()
    print(f"in AnalyzeDex 9")
    androconf.debug("DREF ...")
    d.create_dref()
    print(f"in AnalyzeDex 10")
    print(f"what is d, dx: {d}, {dx}")
    return d, dx
